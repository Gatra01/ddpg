...
parser.add_argument('--save_interval', type=int, default=100, help='Model saving interval, in steps.') #aslinya 1e5
parser.add_argument('--eval_interval', type=int, default=200, help='Model evaluating interval, in steps.') #aslinya 2e3
...
parser.add_argument('--random_steps', type=int, default=1000, help='random steps before trianing')
